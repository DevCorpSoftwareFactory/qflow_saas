...
class LocalUnitsOfMeasureData extends DataClass
  ...
  factory LocalUnitsOfMeasureData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $LocalProductsTable extends LocalProducts
  ...
  static const VerificationMeta _isPurchasableMeta = const VerificationMeta(
    'isPurchasable',
  );
  @override
  ...
  static const VerificationMeta _requiresCoolingMeta = const VerificationMeta(
    'requiresCooling',
  );
  @override
  ...
  LocalProduct map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalProduct(
      ...
      isPurchasable: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_purchasable'],
      )!,
      isReturnable: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_returnable'],
      )!,
      requiresCooling: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}requires_cooling'],
      )!,
...
class LocalProduct extends DataClass implements Insertable<LocalProduct> {
  ...
  factory LocalProduct.fromJson(
    ...
    return LocalProduct(
      ...
      storageTemperatureMin: serializer.fromJson<double?>(
        json['storageTemperatureMin'],
      ),
      storageTemperatureMax: serializer.fromJson<double?>(
        json['storageTemperatureMax'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'storageTemperatureMin': serializer.toJson<double?>(
        storageTemperatureMin,
      ),
      'storageTemperatureMax': serializer.toJson<double?>(
        storageTemperatureMax,
      ),
...
class LocalProductsCompanion extends UpdateCompanion<LocalProduct> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (storageTemperatureMin.present) {
      map['storage_temperature_min'] = Variable<double>(
        storageTemperatureMin.value,
      );
    }
    if (storageTemperatureMax.present) {
      map['storage_temperature_max'] = Variable<double>(
        storageTemperatureMax.value,
      );
    }
...
class $LocalInventoryLotsTable extends LocalInventoryLots
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<LocalInventoryLot> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  LocalInventoryLot map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalInventoryLot(
      ...
      status: $LocalInventoryLotsTable.$converterstatus.fromSql(
...
class LocalInventoryLot extends DataClass
  ...
  factory LocalInventoryLot.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return LocalInventoryLot(
      ...
      variantId: serializer.fromJson<String>(json['variantId']),
      purchaseInvoiceId: serializer.fromJson<String?>(
        json['purchaseInvoiceId'],
      ),
      ...
      status: $LocalInventoryLotsTable.$converterstatus.fromJson(
...
class $LocalCustomersTable extends LocalCustomers
  ...
  customerType = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<CustomerType>($LocalCustomersTable.$convertercustomerType);
  ...
  static const VerificationMeta _deliveryZoneMeta = const VerificationMeta(
    'deliveryZone',
  );
  @override
  ...
  LocalCustomer map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalCustomer(
      ...
      deliveryZone: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}delivery_zone'],
      ),
      ...
      status: $LocalCustomersTable.$converterstatus.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}status'],
        )!,
  ...
  $convertercustomerType = const EnumNameConverter<CustomerType>(
    CustomerType.values,
  );
...
class LocalCustomer extends DataClass implements Insertable<LocalCustomer> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['status'] = Variable<String>(
        $LocalCustomersTable.$converterstatus.toSql(status),
      );
    }
  ...
  factory LocalCustomer.fromJson(
    ...
    return LocalCustomer(
      ...
      tenantId: serializer.fromJson<String>(json['tenantId']),
      code: serializer.fromJson<String>(json['code']),
      customerType: $LocalCustomersTable.$convertercustomerType.fromJson(
        serializer.fromJson<String>(json['customerType']),
      ),
      ...
      priceListId: serializer.fromJson<String?>(json['priceListId']),
      status: $LocalCustomersTable.$converterstatus.fromJson(
        serializer.fromJson<String>(json['status']),
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'priceListId': serializer.toJson<String?>(priceListId),
      'status': serializer.toJson<String>(
        $LocalCustomersTable.$converterstatus.toJson(status),
      ),
  ...
  LocalCustomer copyWith({
    ...
    deliveryZone: deliveryZone.present ? deliveryZone.value : this.deliveryZone,
...
class LocalCustomersCompanion extends UpdateCompanion<LocalCustomer> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (customerType.present) {
      map['customer_type'] = Variable<String>(
        $LocalCustomersTable.$convertercustomerType.toSql(customerType.value),
      );
    }
    if (fullName.present) {
...
class $LocalCashRegistersTable extends LocalCashRegisters
  ...
  static const VerificationMeta _printerConfigMeta = const VerificationMeta(
    'printerConfig',
  );
  @override
  ...
  LocalCashRegister map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalCashRegister(
      ...
      printerConfig: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}printer_config'],
      ),
      isActive: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_active'],
...
class LocalCashRegister extends DataClass
  ...
  LocalCashRegister copyWith({
    ...
    code: code ?? this.code,
    name: name ?? this.name,
    printerConfig: printerConfig.present
        ? printerConfig.value
        : this.printerConfig,
    isActive: isActive ?? this.isActive,
    createdAt: createdAt ?? this.createdAt,
...
class LocalCashSession extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || differenceJustification != null) {
      map['difference_justification'] = Variable<String>(
        differenceJustification,
      );
    }
    {
  ...
  factory LocalCashSession.fromJson(
    ...
    return LocalCashSession(
      ...
      differenceJustification: serializer.fromJson<String?>(
        json['differenceJustification'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'differenceJustification': serializer.toJson<String?>(
        differenceJustification,
      ),
      'status': serializer.toJson<String>(
...
class $LocalCashMovementsTable extends LocalCashMovements
  ...
  static const VerificationMeta _evidenceUrlMeta = const VerificationMeta(
    'evidenceUrl',
  );
  @override
  ...
  LocalCashMovement map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LocalCashMovement(
      ...
      evidenceUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}evidence_url'],
      ),
      createdBy: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}created_by'],
...
class LocalCashMovement extends DataClass
  ...
  LocalCashMovement copyWithCompanion(LocalCashMovementsCompanion data) {
    return LocalCashMovement(
      ...
      reference: data.reference.present ? data.reference.value : this.reference,
      evidenceUrl: data.evidenceUrl.present
          ? data.evidenceUrl.value
          : this.evidenceUrl,
      createdBy: data.createdBy.present ? data.createdBy.value : this.createdBy,
      synced: data.synced.present ? data.synced.value : this.synced,
      syncedAt: data.syncedAt.present ? data.syncedAt.value : this.syncedAt,
...
class $$LocalUnitsOfMeasureTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
  ...
  $$LocalUnitsOfMeasureTableTableManager(
    _$AppDatabase db,
    $LocalUnitsOfMeasureTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$LocalUnitsOfMeasureTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LocalUnitsOfMeasureTable,
      LocalUnitsOfMeasureData,
...
final class $$LocalProductVariantsTableReferences
  ...
  _localInventoryLotsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.localInventoryLots,
        aliasName: $_aliasNameGenerator(
          db.localProductVariants.id,
          db.localInventoryLots.variantId,
        ),
      );
  ...
  $$LocalInventoryLotsTableProcessedTableManager get localInventoryLotsRefs {
    final manager = $$LocalInventoryLotsTableTableManager(
      $_db,
      $_db.localInventoryLots,
    ).filter((f) => f.variantId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _localInventoryLotsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
final class $$LocalInventoryLotsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
...
class $$LocalInventoryLotsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $LocalInventoryLotsTable,
...
typedef $$LocalInventoryLotsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LocalInventoryLotsTable,
      LocalInventoryLot,
...
class $$LocalCustomersTableTableManager
    extends
        RootTableManager<
          ...
          LocalCustomer,
          PrefetchHooks Function({bool priceListId, bool localSalesRefs})
        > {
    ...
    $LocalCustomersTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({priceListId = false, localSalesRefs = false}) {
                return PrefetchHooks(
                  db: db,
