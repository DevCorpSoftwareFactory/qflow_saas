...
export class CashSessionService {
    ...
    async closeSession(
        ...
        return this.dataSource.transaction(async (manager) => {
            ...
            this.logger.log(`Session ${session.id} closed. Declared: ${declaredAmount}, System: ${session.systemAmount}`);
            return session;
        });
    }
    ...
    async updateSessionBalance(
        ...
        await manager.increment(CashSession, { id: sessionId }, 'systemAmount', delta);
    }
}
