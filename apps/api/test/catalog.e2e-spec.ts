...
describe('Catalog E2E Tests', () => {
  ...
  describe('GET /catalog/categories', () => {
    ...
    it('should return categories', async () => {
      ...
      expect(
        response.body.items.some((i: any) => i.id === testCategoryId),
      ).toBe(true);
    });
  });
  ...
  describe('GET /catalog/products', () => {
    it('should return products', async () => {
      ...
      expect(response.body).toHaveProperty('items');
      expect(Array.isArray(response.body.items)).toBe(true);
      expect(response.body.items.some((i: any) => i.id === testProductId)).toBe(
        true,
      );
    });
  });
  ...
  describe('GET /catalog/brands', () => {
    it('should return brands', async () => {
      ...
      expect(response.body).toHaveProperty('items');
      expect(Array.isArray(response.body.items)).toBe(true);
      expect(response.body.items.some((i: any) => i.id === testBrandId)).toBe(
        true,
      );
    });
  });
  ...
  describe('GET /catalog/units', () => {
    it('should return units', async () => {
      ...
      expect(response.body).toHaveProperty('items');
      expect(Array.isArray(response.body.items)).toBe(true);
      expect(response.body.items.some((i: any) => i.id === testUnitId)).toBe(
        true,
      );
    });
  });
  ...
  describe('GET /catalog/customers', () => {
    it('should return customers', async () => {
      ...
      expect(Array.isArray(response.body.items)).toBe(true);
      expect(
        response.body.items.some((i: any) => i.id === testCustomerId),
      ).toBe(true);
    });
  });
  ...
  describe('GET /catalog/price-lists', () => {
    it('should return price lists', async () => {
      ...
      expect(Array.isArray(response.body.items)).toBe(true);
      expect(
        response.body.items.some((i: any) => i.id === testPriceListId),
      ).toBe(true);
    });
  });
});
