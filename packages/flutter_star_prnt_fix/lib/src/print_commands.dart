...
class PrintCommands {
  ...
  appendBitmap({
    ...
    Map<String, dynamic> command = {"appendBitmap": path};
  ...
  appendBitmapByte({
    ...
    Map<String, dynamic> command = {"appendBitmapByteArray": byteData};
    command['bothScale'] = bothScale;
    command['diffusion'] = diffusion;
    command['width'] = width;
    if (absolutePosition != null)
  ...
  appendBitmapText({
    ...
    Map<String, dynamic> command = {"appendBitmapText": text};
    command['bothScale'] = bothScale;
    command['diffusion'] = diffusion;
  ...
  static Future<Uint8List?> createImageFromWidget(
    ...
    final RenderView renderView = RenderView(
      ...
      configuration: ViewConfiguration(devicePixelRatio: 1.0),
    );
